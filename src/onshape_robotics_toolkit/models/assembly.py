...
class Part(IDBase):
    ...
    MassProperty: MassProperties | None = Field(
        None,
        description="The mass properties of the part, this is a retrieved via a separate API call.",
    )

    isRigidAssembly: bool = Field(
        False,
        description="Indicates if the part is a rigid assembly, i.e., a sub-assembly with no degrees of freedom.",
    )
    rigidAssemblyToPartTF: dict[str, "MatedCS"] | None = Field(
        None,
        description="The transformation matrix from the rigid assembly to the part coordinate system.",
    )
    rigidAssemblyWorkspaceId: str | None = Field(
        None,
        description="The workspace ID of the rigid assembly, if it is a sub-assembly.",
    )
...
class MatedCS(BaseModel):
    ...
    part_tf: np.matrix = Field(
        None,
        description="The 4x4 transformation matrix from the part coordinate system to the mate coordinate system.",
    )
...
class MatedEntity(BaseModel):
    ...
    parentCS: MatedCS = Field(
        None,
        description="The 4x4 transformation matrix for the mate feature, used for custom transformations.",
    )
...
class SubAssembly(IDBase):
    ...
    MassProperty: MassProperties | None = Field(
        None,
        description="The mass properties of the sub-assembly, this is a retrieved via a separate API call.",
    )
