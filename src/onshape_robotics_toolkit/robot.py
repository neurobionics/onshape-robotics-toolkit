...
from onshape_robotics_toolkit.models.mjcf import (
    Actuator,
    Encoder,
    ForceSensor,
    Light,
...
from onshape_robotics_toolkit.urdf import (
    get_joint_name,
    get_robot_joint,
    get_robot_link,
    get_topological_mates,
)
...
class Robot:
    ...
    def __init__(
        ...
        self.model: ET.Element | None = None
    ...
    def add_actuator(
        ...
        if add_force_sensor:
            self.add_sensor(
                actuator_name + "-frc",
                ForceSensor(actuator_name + "-frc", actuator_name),
            )
    ...
    def show_graph(self, file_name: str | None = None) -> None:
        """
...
if __name__ == "__main__":
    ...
    robot = Robot.from_urdf(
        file_name="E:/onshape-robotics-toolkit/playground/ballbot.urdf",
